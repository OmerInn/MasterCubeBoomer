...
public class CubeSpawner : MonoBehaviour
{
    ...
    [SerializeField] private bool autoQueueGrow = true; //otomatik Kuyruk Büyümesi
    ...
    private void AddCubeToQueue()
    {
        ...
        ///Queue (Kuyruk), ilk giren ilk çýkar iþleyiþine sahip bir koleksiyondur(FIFO). 
        ///Koleksiyondan bir eleman çýkarýlmak istenildiðinden, kuyruðun en önünde yer eleman çýkartýlacaktýr.
        ///Yeni eklenmek istenen bir eleman ise kuyruðun en sonuna eklenecektir.
        ///Enqueue() Metodu; Parametre olarak girilen öðeyi kuyruðun sonuna eklemektedir.
        ///Dequeue() Metodu; Kuyruðun baþýndaki öðeyi döndürür ve sonra öðe kuyruktan çýkarýlýr/silinir.
        ///Kuyruk boþken Dequeue() metodu çaðrýlýrsa InvalidOperationException fýrlatýr.
    }
    ...
    {
        return cubeColors[(int)(Mathf.Log(number) / Mathf.Log(2)) - 1]; //-1(index start with 0) :dizin 0 ile baþlar
